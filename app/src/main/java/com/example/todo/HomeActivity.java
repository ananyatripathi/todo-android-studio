...
public class HomeActivity extends AppCompatActivity {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(mDate)) {
                    Date.setError("Description Required");
                    return;
                    ...
                    Model model = new Model(mTask, mDescription, mDate, id, date);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setDate(String Date) {
            TextView DateTectView = mView.findViewById(R.id.descriptionTv);
    ...
    private void updateTask() {
        ...
        final EditText mDate = findViewById(R.id.mEditTextDescription);
        ...
        mDate.setText(description);
        mDate.setSelection(description.length());
