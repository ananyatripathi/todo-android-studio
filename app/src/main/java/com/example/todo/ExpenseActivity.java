...
public class ExpenseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        todayItemsAdapter = new TodayItemsAdapter(ExpenseActivity.this, myDataList);
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mItem.equalsIgnoreCase("select item")){
                    Toast.makeText(ExpenseActivity.this, "Please select a valid item", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    ref.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(ExpenseActivity.this, "Item added successfully", Toast.LENGTH_SHORT).show();
                            }else {
                                Toast.makeText(ExpenseActivity.this, "Failed to add Item", Toast.LENGTH_SHORT).show();
                            }
                            loader.dismiss();
                        }
                    });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                ...
                finish();
            case R.id.todo:
                Intent intent1  = new Intent(ExpenseActivity.this, HomeActivity.class);
